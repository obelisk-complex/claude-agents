...
7. Disconfirm each finding before reporting it: state the evidence that would contradict it, and weigh whether an innocent explanation - a deliberate design choice, or conformance met under different wording - fits the evidence better; keep the finding only if that disconfirmation fails.
